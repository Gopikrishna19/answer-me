Public Class Question_25
    ...
    Private Sub Button1_MouseMove(ByVal sender As System.Object, ByVal e As System.Windows.Input.MouseEventArgs) Handles Button1.MouseMove
        ...
        MainPath.Fill = Brushes.White
        Button2.Opacity = 100
        pathCons.Opacity = 100
        pathArrow.Opacity = 100
        pathHint.Opacity = 100
        pathMsg.Opacity = 100
        pathCons.Visibility = Windows.Visibility.Visible
    End Sub
    ...
    Private Sub UserControl_Loaded() Handles MyBase.Loaded
        ...
        pathHint.Opacity = 0
        pathMsg.Opacity = 0
        pathCons.Visibility = Windows.Visibility.Hidden
    End Sub
    ...
    Private Sub pathCons_MouseMove(ByVal sender As System.Object, ByVal e As System.Windows.Input.MouseEventArgs) Handles pathCons.MouseEnter
